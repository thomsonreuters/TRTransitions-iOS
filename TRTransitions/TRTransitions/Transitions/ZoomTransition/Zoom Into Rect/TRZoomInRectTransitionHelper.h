//
//  TRZoomInRectTransitionHelper.h
//  TRZoomTransition
...
typedef NS_ENUM(NSUInteger, TRZoomInRectTransitionMode) {
    TRZoomInRectTransitionModeSameContent = 0,
    TRZoomInRectTransitionModeDifferentContent = 1
};

@interface TRZoomInRectTransitionHelper : NSObject
