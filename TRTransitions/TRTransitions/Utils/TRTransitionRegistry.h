...
typedef NSString TRTransitionIdentifier;

@class TRTransition;
@interface TRTransitionRegistry : NSObject <UINavigationControllerDelegate, UITabBarControllerDelegate>
