...
@protocol TRTransitionViewControllerProtocol;

@interface TRTransitionContext : NSObject

@property (strong, nonatomic, readonly) UIViewController<TRTransitionViewControllerProtocol> *fromVC;
@property (strong, nonatomic, readonly) UIViewController<TRTransitionViewControllerProtocol> *toVC;
